  ...
  public: {
    Tables: {
      ...
      session_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_details_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
      ...
      session_skill_entries: {
        Row: {
          ...
          target_f_value: number | null
          target_i: string | null
          target_i_value: number | null
          target_s: string | null
          target_s_value: number | null
          updated_at: string
        }
        Insert: {
          activity_impact_score?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "session_skill_entries_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
